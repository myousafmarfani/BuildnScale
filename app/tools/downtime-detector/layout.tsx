...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.buildnscale.dev/tools/downtime-detector',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Downtime Detector", item: "https://www.buildnscale.dev/tools/downtime-detector" },
  ],
}
